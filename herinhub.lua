...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Niga Hub hello Bro<Color=/>"):Display()
    wait(.5)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Hub make by herin cre zy<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Niga Network", HidePremium = false, IntroText = "dcm re rach⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("[+] Herin X Hub Lmao skid hub")
...
C:AddButton({
    ...
    Callback = function(value)
        setclipboard("discord.gg/UGMweHgVkp")
    end
})
